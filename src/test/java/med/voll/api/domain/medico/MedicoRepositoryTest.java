...
public class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando o único médico cadastrado não está" +
            "disponível na data")
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Bernardo de Souza", "bernardo@voll.med",
                "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Evandro Lovato", "evandro@email.com",
                "00000000000");
